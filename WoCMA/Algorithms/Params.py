...
def get_args(n,m,PT,MT,ni, ST, s,means_m=1):
    ...
    parser.add_argument('--Setup_Time', default=ST, type=list, help='setup time')
    parser.add_argument('--s', default=s, type=list, help='setup worker number')
    ...
    parser.add_argument('--gene_size', default=50, type=int, help='generation size of the genetic algorithm')
    ...
    parser.add_argument('--p_GS', default=0.4, type=float, help='globel initial rate')
    parser.add_argument('--p_LS', default=0.1, type=float, help='Local initial rate')
    parser.add_argument('--p_RS', default=0.1, type=float, help='random initial rate')
    parser.add_argument('--p_WGS', default=0.2, type=float, help='')
    parser.add_argument('--p_WLS', default=0.2, type=float, help='')
    parser.add_argument('--T', default=3, type=int, help='the number of the weight vectors in the neighborhood of each weight vector')
    parser.add_argument('--H', default=150, type=int,
